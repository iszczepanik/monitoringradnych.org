...
class ProjektController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Projekt']))
		{
			...
			$model->KategorieUchwal = $_POST['Projekt']['kategorieUchwalIDs'] != '' ?
				$_POST['Projekt']['kategorieUchwalIDs'] : null;
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Projekt');
	...
	{
		$model=new Projekt('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Projekt']))
			$model->attributes=$_GET['Projekt'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='projekt-form')
		{
