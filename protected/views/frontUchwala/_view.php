<tr><td>
	...
	<?
	echo Vote::VoteIconStatic(1)." ".Vote::VoteLabelStatic(1)." (".$data->votes['count_za'].")";
	?>
	</div>
	<div class="pull-left" style="padding-right: 20px;" > 
	<?
	echo Vote::VoteIconStatic(-1)." ".Vote::VoteLabelStatic(-1)." (".$data->votes['count_przeciw'].")";
	?>
	</div>
		<div class="pull-left" style="padding-right: 20px;" > 
	<?
	echo Vote::VoteIconStatic(0)." ".Vote::VoteLabelStatic(0)." (".$data->votes['count_wstrzymal'].")";
	?>
	</div>
	<div class="pull-left" style="padding-right: 20px;" > 
	<?
	echo Vote::VoteIconStatic(2)." ".Vote::VoteLabelStatic(2)." (".$data->votes['count_nieobecny'].")";
	?>
	</div>
	<div style="clear: both;"></div>
</td>
